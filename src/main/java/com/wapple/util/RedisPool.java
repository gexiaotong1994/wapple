...
public class RedisPool {
	...
	private static Integer dbINdex = Integer.parseInt(PropertiesUtil.getProperty("redis.db.index", "20"));
	...
	private static void initPool() {
		...
		pool = new JedisPool(config, redisIp, redisPort, 1000 * 2, redisPassword, dbINdex);
