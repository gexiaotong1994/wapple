                          ...
                          <div class="panel-body">
                              <div class="form">
                                  <form class="form-validate form-horizontal " id="register_form" method="get" action="">
                                      ...
                                      <div class="form-group ">
                                          <label for="agree" class="control-label col-lg-2 col-sm-3">用户状态 <span class="required">*</span></label>
                                          <div class="col-lg-10 col-sm-9">
                                                                                        未认证 <input  type="checkbox" style="width: 20px" class="checkbox form-control" id="agree" name="agree" />
